...
class TotalLoss(nn.Module):
    ...
    def __init__(self):
        ...
        self.seg_criterion1 = TverskyLoss(mode="multiclass", alpha=0.7, beta=0.3, gamma=4.0/3, from_logits=True)
        self.seg_criterion2 = FocalLossSeg(mode="multiclass", alpha=0.25)
    ...
    def forward(self, outputs, targets):
        ...
        tversky_loss = self.seg_criterion1(out_da, seg_da)+self.seg_criterionll(out_ll, seg_ll)
        focal_loss = self.seg_criterion2(out_ll, seg_ll)+self.seg_criterion2(out_da, seg_da)
