...
class TotalLoss(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        tversky_loss = 0.6*self.seg_tver_da(out_da, seg_da)+1.4*self.seg_tver_ll(out_ll, seg_ll)
        focal_loss = 1.4*self.seg_focal(out_ll, seg_ll)+0.6*self.seg_focal(out_da, seg_da)
